...
const toManyRequests = document.querySelector(".toManyRequests")
const incorrectPassword = document.querySelector(".incorrectPassword")
const mailAlreadyUsed = document.querySelector(".mailAlreadyUsed")
...
mailAlreadyUsed.style.display = 'none'
...
function checkForEmptyRegister() {
    ...
    const isValidEmailFormat = isValidEmail(emailRegister.value)

    
    if (firstNameRegister.value === '') {
        firstNameRegister.style.border = '1px solid red'
    } 
    if(firstNameRegister.value !== '' ){
        firstNameRegister.style.border = '1px solid black'      
    }

    if (lastNameRegister.value === '') {
        lastNameRegister.style.border = '1px solid red'
    } 
    
    if(lastNameRegister.value !== '') {
        lastNameRegister.style.border = '1px solid black'      
    }



    if (validate_password()) {
        passwoardRegister.style.border = '1px solid black';
        invalidPassword.style.display = "none";
    }
    
    if (!validate_password()) {
        passwoardRegister.style.border = '1px solid red';
    ...
    if(isValidEmailFormat) {
        emailRegister.style.border = '1px solid black';
        allvalidEmail.forEach(validEmail => {
            validEmail.style.display = "none"
            mailAlreadyUsed.style.display = 'none'
        })
...
function eraseContent(){
    ...
    firstNameRegister.style.border = '1px solid black'
    lastNameRegister.style.border = '1px solid black'
    emailLogin.style.border = '1px solid black'
    passwoardLogin.style.border = '1px solid black'
